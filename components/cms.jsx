...
export default function CMSComplete() {
  ...
  const handleDrop = (e) => {
    ...
    if (file) processLocalAndUpload(file);
  };
              ...
              >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-2 border rounded-lg bg-[var(--background)] border-[var(--sidebar-border)] text-[var(--text-primary)] resize-none"

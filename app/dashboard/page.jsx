  ...
  <div className="bg-white rounded-2xl p-4 sm:p-6 border-l-4 border-blue-400 shadow-sm">
    <div className="flex items-start justify-between gap-3 sm:gap-0">
      <div className="flex-1">
        ...
        <p className={`text-xs sm:text-sm mt-2 flex items-center gap-1 ${isPositive ? 'text-teal-600' : 'text-red-600'}`}>
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pb-6 sm:pb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          {/* Users Chart */}
          <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm overflow-hidden">
            <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-4">New vs Returning Users</h3>
            <ResponsiveContainer width="100%" height={300}>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Product Name</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Location</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Date - Time</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Piece</th>
                  <th className="px-4 sm:px-6 py-3 text-left text-xs sm:text-sm font-semibold text-gray-900">Amount</th>
                  ...
                  <tr key={deal.id} className="border-b border-gray-200 hover:bg-gray-50">
                    <td className="px-4 sm:px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs sm:text-sm font-medium text-gray-900">{deal.product}</span>
                      </div>
                    </td>
                    <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600 hidden sm:table-cell">{deal.location}</td>
                    <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-600 hidden md:table-cell">{deal.date}</td>
                    <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-900 font-medium hidden lg:table-cell">{deal.piece}</td>
                    <td className="px-4 sm:px-6 py-4 text-xs sm:text-sm text-gray-900 font-medium">{deal.amount}</td>
                    <td className="px-4 sm:px-6 py-4">
                      <span className={`px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-semibold ${deal.statusColor}`}>
                        {deal.status}
                      </span>
                    </td>
                  </tr>
